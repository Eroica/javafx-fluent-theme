package earth.groundctrl.fluent.demo.controllers

import earth.groundctrl.fluent.demo.MainActivity
import earth.groundctrl.fluent.demo.fragments.ComboBoxFragment
import earth.groundctrl.fluent.demo.fragments.DialogFragment
import earth.groundctrl.fluent.demo.fragments.HeaderBarFragment
import earth.groundctrl.fluent.demo.fragments.HomeFragment
import earth.groundctrl.fluent.demo.fragments.InfoBarFragment
import earth.groundctrl.fluent.demo.fragments.ProgressBarFragment
import earth.groundctrl.fluent.demo.fragments.SystemBackdropFragment
...
open class BaseFragment(@NamedArg("resourceId") private val resourceId: String) : VBox(), IFragment {
    ...
    override fun onCreateView() {
        val bundle = ResourceBundle.getBundle("/earth/groundctrl/fluent/demo/strings")
        FXMLLoader(javaClass.getResource("/earth/groundctrl/fluent/demo/fragments/$resourceId"), bundle).apply {
